...
public class Material {
    ...
    public Material(int gatepassInwardId, String inwardDate, int gatePassType, int gatePassSubType, String invoiceNumber, String partyName, int partyId, int securityId, String securityName, String personPhoto, String inwardPhoto, String inTime, float noOfNugs, int itemType, int delStatus, int status, int toEmpId, int toDeptId, int toStatus, String toEmpName, String toDeptName, Integer exInt1, Integer exInt2, Integer exInt3, String exVar1, String exVar2, String exVar3) {

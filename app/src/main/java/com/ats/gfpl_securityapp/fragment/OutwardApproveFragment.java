...
import com.ats.gfpl_securityapp.adapter.OutwardApproveAdapter;
 ...
 */
public class OutwardApproveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_outward_approve, container, false);
        getActivity().setTitle("Material Gate Pass Approve");
                ...
                public void onResponse(Call<ArrayList<Outward>> call, Response<ArrayList<Outward>> response) {
                    try {
                        if (response.body() != null) {
                            ...
                            Log.e("OUTWARD LIST : ", " - " + response.body());
                            outwardList.clear();
                            outwardList = response.body();

                            OutwardApproveAdapter adapter = new OutwardApproveAdapter(outwardList, getContext(),syncArray,loginUser);
